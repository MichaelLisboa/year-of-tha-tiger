export const zodiac = [
	{
		...
		"language": {
			"jive": {
				"story": "Rat got waaay down real early. On his way t'de gate, he runs up on some river. Ah be baaad... He had t'stop dere, owin' t'de swift current. Afta' waitin' some long time, Rat noticed Ox about t'cross de riva' and swiftly jumped into Ox's ear. Ah be baaad...De diligent Ox did not mind at all and simply continued. Afta' crossin' de river, he raced towards de palace uh de Jade Empuh'o'. Ah be baaad... Rada' dan say dank ya' on de oda' side, de rat made some dash fo' de finish wid de ox not far behind. Dat’s why de rat be fust creature in de cycle, followed by de ox.",
	...
	},
	{
		...
		"language": {
			"jive": {
				"story": "Due to being large, powerful, and adept both on land and in water, the Rat asked the good-natured Ox for a ride on its back, but then ungratefully jumped off at the last minute to cross the finish line first. As Ox came in second, he said to Rat, I saw what you did there.It’ s okay, because being first in line means being first in trouble.",
