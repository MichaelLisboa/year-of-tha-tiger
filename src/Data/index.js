export const zodiac = [{
	...
	"language": {
		"jive": {
			"story": ["Dog, ya'know? Dude knows how ta'have a good time, yo! Dog gots tha groove an'was thinkin' first place would be ez-E. Dog got right up at the river, but then saw Cat who was all wet (y'see, cuz Rat tricked Cat). Dog bein' Dog chased Cat just fo'fun. By the time Dog rolled up to tha Gate it was eleventh place."],
