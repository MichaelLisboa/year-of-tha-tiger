export const zodiac = [{
	...
	"language": {
		...
		"english": {
			...
			"personality": ["People who were born in the Year of the Rat are said to be quick-witted, resourceful, and smart but lack courage. Due to their work ethic, however, they are thought to be wealthy and prosperous. They are always considerate of their families and friends. Lucky colours: blue, gold, green."],
	...
	"language": {
		...
		"english": {
			...
			"personality": ["An Ox is said to have an honest personality. People born in the Year of the Ox are known for being diligent, dependable, strong, and determined, though find it difficult to communicate. They are sometimes stubborn and stick to their own ways. Lucky colours: white, yellow, green."],
			"forecast": ["Ox will be helped by people in high places this year, and no matter what luck they encounter, they will be able to turn it into good fortune. There will be many friends around to help them on a daily basis as well. Generally speaking, you will be favored by good fortune this year, with relatively smooth career development. Watch out for people jealous of your good fortune, waiting to replace you in some way. Try to be aware if someone may not have the best intentions in their dealings with you in 2022."]
		}
	}
}, {
	"chapter": 3,
	...
	"language": {
		"jive": {
			...
			"forecast": ["It's tha Year of tha Tiga' in 2022, Tiger's Ben Min' Nian. 'S coo', bro. Tha year uh Fan Tai Sui which is offendin' tha powerful god that governs an entire year. Get down! It's unfo'tunate fo' Tigers cuz some folks Ben Min' Nian is tha year they gonna suffa' setbacks and bad fortune at tha least, even get some disasters. But don't get down, 'cuz there are ways t'combat tha bad-ass luck, and if ya' work along with tha flow of fortune ya' should be able t'overcome any serious challenges and mosey on waaay down unscathed from tha year. Ah be baaad..."]
		},
		"english": {
			...
			"personality": ["People born in the Year of the Tiger are born leaders. They are brave, competitive, unpredictable, and confident. Confident, charming and well liked they sometimes possess a stubborn personality too. Lucky colours: blue, gray, orange. There is never a dull moment with a Tiger."],
			"forecast": ["It's the Year of the Tiger in 2022, Tiger's Ben Ming Nian. It is therefore their year of Fan Tai Sui—offending the powerful yearly god that governs an entire year. This is bad for Tigers, it is the year they will likely suffer setbacks and misunderstandings at the very least, possibly even meet with more serious disasters. Fight this turn of bad luck by working with the flow of fortune and destiny and you will overcome any serious misfortune to come out from the year."]
		}
	}
}, {
	"chapter": 4,
	...
	"language": {
		...
		"english": {
			...
			"personality": ["Rabbits tend to be of a more gentle nature. Quiet, elegant, kind, and patient, rabbits have many positive characteristics but can also be known to be superficial. Lucky colours: pink, red, purple, blue. Rabbits are pros when it comes to negotiation on risky business."],
	...
	"language": {
		...
		"english": {
			...
			"personality": ["Most people born in the Year of the Dragon are full of fighting spirit and strength. Hot-headed with a sharp tongue, Dragons are also said to be confident and intelligent, and natural leaders. Lucky colours: gold, silver, gray."],
	...
	"language": {
		...
		"english": {
			...
			"personality": ["People born in the years of the Snake easily attract others for their mysterious character and graceful behaviors. Intelligent and wise, goal-oriented and hate to fail, people born in the Year of the Snake are supposed to be the most intuitive and a symbol of wisdom. Lucky colours: black, red, yellow."],
	...
	"language": {
		...
		"english": {
			...
			"personality": ["Compared to other zodiac signs, people with Chinese zodiac Horse sign are more lively, energetic, courageous, and enthusiastic about people and life. People born in the Year of the Horse are said to be active, animated and energetic. A lover of sports events, live concerts, and parties - horses crave the spotlight. Lucky colours: green, yellow."],
