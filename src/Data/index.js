export const zodiac = [{
	...
	"language": {
		"jive": {
			...
			"personality": ["Folks bo'n in de years uh de Snake easily attract oders fo' de mah'sterious characta' and graceful behavio's. Intelligent and wise, goal-o'iented and hate t'fail, sucka's bo'n in de Year uh de Snake are supposed t'be da damn most intuitive and some symbol uh wisdom. 'S coo', bro. Lucky colo's, dig dis: black, red, yellow."],
