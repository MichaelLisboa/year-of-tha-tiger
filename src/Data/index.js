export const zodiac = [{
	...
	"language": {
		"jive": {
			...
			"forecast": ["People bo'n in years uh de Ox will be helped by folks in high places dis year, and no matta' whut luck dey encounter, Oxen gotss'ta be able t'turn it into groovie luck. There will be many homeys around t'help them on a daily basis. Derefo'e, Oxen should cherish all uh tha homeys. Generally speakin', Oxen will be favo'ed by groovie fo'tune wid smooth career development. On tha oda' hand, dere may be sucka's jealous of their groovie fo'tune lurkin' in de shadows, waitin' t'replace Oxen in some way. While lovin' tha homeys, try t'be aware if someone may not gotss' tha damn best intentions in dealin's wid you in 2022."]
		},
		"english": {
	...
	"language": {
		"jive": {
			...
			"personality": ["Folks bo'n in de Year uh de Tiga' are bo'n leaders. Dey are brave n’competitive, unpredictable, and confident. Confident, charmin' and sheeit dey sometimes possess some jive turkey personality too. There is never dull times with a Tiger. Lucky colo's, dig dis: blue, grey, orange. Boogie down!"],
			"forecast": ["It’s tha Year uh de Tiga' in 2022, Tiger’s Ben Min' Nian. 'S coo', bro. Tha year uh Fan Tai Sui which is offendin' tha powerful god that governs an entire year. Get down! It’s unfo'tunate fo' Tigers cuz some folks Ben Min' Nian is tha year they gonna suffa' setbacks and bad fortune at tha least, possibly even get some disasters on some serious scale. But fear not, 'cuz there are ways t'combat tha turn of bad-ass luck, and if ya' wo'k along with tha flow uh fortune and destiny, ya' should be able t'overcome any serious challenges and mosey on waaay down out unscathed from tha year. Ah be baaad..."]
		},
		"english": {
	...
	"language": {
		"jive": {
			...
			"forecast": ["Smart bunny, we need not tell you how important it is to save money. You know it right! You are sensitive, romantic and considerate when it comes to love. You are about to bump into somebody whom you might just start liking. Your tenderness could be playing a key role in attracting the opposite sex. And if you wish to be your partner's munchkin for a longer time, then stop playing mysterious and better be serious right at the start. You bunnies are known to be overly sentimental. So you gotta keep away from those strong spirits. And if you feel like taking the cake, the baker and the bakery with you, then let us warn you, that too on a serious note; don't be greedy!"]
		},
		"english": {
	...
	"language": {
		"jive": {
			...
			"personality": ["Most folks bo'n in de Year uh de Dragon are full uh fightin' spirit and strength. Hot-'haided wid some sharp tongue, Dragons are also said t'be confident and intelligent, and natural leaders. Lucky colo’s, dig dis: gold, silver, grey. Get the funk,yo!"],
	...
	"language": {
		"jive": {
			...
			"personality": ["Compared t'otha' animals, folks wid de Horse sign are mo' lively, energetic, courageous, and enthusiastic about sucka's and life. Get up and get down! Folks bo'n in de Year uh de Horse are said t'be active and energetic. A lova' of sports events, live concerts, n'parties - Horses crave tha damn spotlight. Lucky colo's, dig dis: green, yellow."],
	...
	"language": {
		"jive": {
			...
			"personality": ["Folks bo'n in de Year uh de Goat are generally thought of as bein' gentle, mild-mannered, shy, sympathetic and groovie at heart. They care about otha’peoples' feelin's and neva' intend t'hurt sucka's. Right On! Creative and tough unda' de surface. What it is, Mama! Lucky colo's, dig dis: brown, red, purple."],
	...
	"language": {
		"jive": {
			...
			"personality": ["Loyalty and honesty are two personality traits uh those folks bo'n in de Year uh de Dog. Kind, cautious, and prudent tho' communicashun is where dey fall waaay down, leadin' t'othas thinkin' dey gotss' some stubbo'n jive turkey. In fact, Dog folks are cautious by nature, which means it may be a long time fo' Dogs t'accept new homeys. Lucky colo's, dig dis: green, red, purple."],
